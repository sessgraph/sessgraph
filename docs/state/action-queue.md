...
| ID | 状态 | 负责人 | 行动 | 退出标准 |
| --- | --- | --- | --- | --- |
| ACT-0002 | 打开 | Owner | 确认初始 license 选择；基础设施项目大概率使用 Apache-2.0。 | 已新增 license 文件，或明确记录延后决策。 |
...
| ACT-0006 | 打开 | Owner | 确认 P0 后下一优先级：PR-0008 checkpoint recovery、package/release hygiene、async job/timer 或其他 v0.3+ 工作。 | 下一个已批准 PR 队列项明确，或明确记录延后决策。 |
