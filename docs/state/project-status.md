...
下一步不要直接实现未排队能力；建议先排队 Safety/Auth 收尾审查或阶段重评估，核对 ADR-0007 / ADR-0008 的本地确定性覆盖，并决定后续是否进入 Parent/Child Session、capability delegation 或真实 identity provider 方向。
