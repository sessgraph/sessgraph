...
下一步不要直接实现未排队能力；如果继续 Safety/Auth，建议基于 ADR-0008 单独排队 approval result runtime flow，覆盖 `approval_result` Signal dispatch、approved dispatch、denied skip、duplicate result idempotency、stale result ignored 和 Checkpoint round-trip。
