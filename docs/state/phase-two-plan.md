...
P1 后续方向重评估结论是优先进入 Memory + Context。PR-0015 Memory + Context ADR、PR-0016 InMemory context builder 和 PR-0017 deterministic memory compaction example/test 已完成。PR-0018 Safety/Auth ADR 和 PR-0019 InMemory capability policy gate 也已完成；approval flow、真实 provider、production policy 和 Parent/Child Session 后续仍需单独排队实现。
