...
仓库已完成规划/bootstrap 和 PR-0002 P0 core data structures。当前目标不是快速堆实现，而是按小 PR 切片继续完成 durable Session runtime core。
...
- Session Inbox、InMemory stores、FakeModel adapter、最小 Activation Runner 和同步 Tool execution 已完成。
- durable Session 闭环稳定后，再加入 wait/resume。
- 确定性测试和最小可运行 example。
